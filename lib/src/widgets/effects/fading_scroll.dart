...
/// [FadingScrollable].
typedef FadingScrollWidgetBuilder =
      ...
      builder: (context, child) {
        ...
        final startAmount =
            !isAttached ||
                ...
                ? 0.0
                : (controller.position.extentBefore / startScrollExtent).clamp(
                  0.0,
                  1.0,
                );
        final endAmount =
            !isAttached ||
                ...
                ? 0.0
                : (controller.position.extentAfter / endScrollExtent).clamp(
                  0.0,
                  1.0,
                );
